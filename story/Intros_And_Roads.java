...
public class Intros_And_Roads {
	...
	public static void main(String[] args) {
	  ...
	  System.out.print("To pick the left path, write L. To carry on on the path you came, write C: ");
	...
	public static void mainPath () {
	    ...
	    if (flash == 'Y') {
	    	 ...
	    	 System.out.println("You haven't used the flashlight, it'll be fine surely.");
